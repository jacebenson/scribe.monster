...
describe('properties', () => {
  ...
  scenario('returns a single property', async (scenario) => {
    const result = await property({ cuid: scenario.property.one.cuid })
  ...
  scenario('updates a property', async (scenario) => {
    const original = await property({ cuid: scenario.property.one.cuid })
  ...
  scenario('deletes a property', async (scenario) => {
    const original = await deleteProperty({ cuid: scenario.property.one.cuid })
    const result = await property({ cuid: original.cuid })
