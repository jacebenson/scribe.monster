...
const ListPage = ({ table, page: rawPage, take: rawTake, where: rawWhere, params }) => {
  console.log({ table, params })

  let { paramsObject, variables } = parseParamsAndVariables({ params, page: rawPage, take: rawTake, where: rawWhere })
