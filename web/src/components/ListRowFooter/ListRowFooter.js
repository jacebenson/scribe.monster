...
const ListRowFooter = ({ total }) => {
  const { table, page, setPage, take, setTake, orderBy, setOrderBy } = React.useContext(ListContext)
  ...
  return (
    <Flex>
      ...
      <ModalJumpToPage isOpen={isOpen} onClose={onClose} currentPage={currentPage} />
      <Button
